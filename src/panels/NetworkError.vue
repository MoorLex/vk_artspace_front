  ...
  <Panel title="Ошибка"
    ...
    <div class="flex flex-col items-center text-center px-3 max-w-sm mx-auto leading-5 my-10">
      ...
      <p class="mb-10 text-secondary">
        Кажется, у Вас пропала связь с космосом, попробуйте переподключится и обновить сервис.
      </p>
