<template>
  <Panel :loading="!profile || !profile.raw">
    ...
    <Banner v-if="canSubscribe"
            class="border-l-0 border-r-0"
            title="Поддержать автора"
            text="Поддержите автора и получите кучу уникальных возможностей!"
            mode="expand"
            @click="() => $refs.donut.open()"/>
    ...
    <Banner v-if="profile.isBanned"
            ...
            text="Доступ к данному профиль был заблокирован за несаблюдение правил сервиса."/>
