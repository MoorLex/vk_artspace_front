<template>
  <ModalCard ref="modal">
    <div class="px-3 py-5 text-center grid gap-5">
      ...
      <h3 class="leading-5 text-lg font-bold">
        Вам не хватает прав доступа
      </h3>

      <p class="leading-5">
        У Вас отсутствует VIP подписка для загрузки нескольких творений в день.
      </p>

      <a v-if="!platform.ios"
         href="https://vk.com/le__moore"
         target="_blank"
         class="block">
